...
def multi_agent_router_call(vAR_user_input):
    ...
    try:
        ...
        agentId=os.environ["MULTI_AGENT_ROUTER_ID"],
        enableTrace = True,
        inputText=vAR_user_input,
        agentAliasId=os.environ["MULTI_AGENT_ROUTER_ALIAS_ID"],
...
def bedrock_multi_agent_router_chat():
    ...
    with container:
        ...
        if submit_button and vAR_user_input and vAR_user_input!='':
            vAR_agent_response,vAR_trace_obj_list,vAR_file_generated,file_name = multi_agent_router_call(vAR_user_input)
