...
def All_Initialization():
    ...
    st.markdown("<h2 style='text-align: center; color: #454545; font-size:20px;'>Platform for Observability and Evaluation of LLM within Your Use Case and Prompts</h2><br><br>", unsafe_allow_html=True)
