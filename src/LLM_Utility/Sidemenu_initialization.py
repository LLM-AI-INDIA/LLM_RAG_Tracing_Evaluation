...
def All_Initialization():
    ...
    st.markdown("<h2 style='text-align: center; color: #454545; font-size:20px;'>Enterprise LLM Platform with Accurate Response, Observability, and Evaluation: Open AI, Bedrock, and Google.</h2><br><br>", unsafe_allow_html=True)
