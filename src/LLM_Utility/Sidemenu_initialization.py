...
def All_Initialization():
    ...
    vAR_choice1 =  st.sidebar.selectbox(" ",('Select Application','LLM Guardrail','LLM as a Judge','LLM Human in the Feedback Loop','LLM Human in the Feedback Loop V2','LLM Agent','LLM Multi Agent')) #,'Policy Analysis - Dialogflow','Policy Analysis - Evaluation'
